...
(function () {
    ...
    var Group = /** @class */ (function () {
        ...
        /**
         * Destroys the tractors buttons, clears the internal criteria and removes it from the dom
         */
        Group.prototype.destroy = function () {
            // Turn off listeners
            this.dom.add.off('.dtsb');
            this.dom.logic.off('.dtsb');
            // Trigger event for tractors at a higher level to pick up on
            this.dom.container
        ...
        /**
         * Locates the tractors logic button to the correct location on the page
         */
        ...
        /**
         * Sets listeners on the tractors elements
         */
        ...
        /**
         * Gets the count for the number of criteria in this group and any sub tractors
         */
        ...
        Group.prototype._setCriteriaListeners = function (criteria) {
            ...
            criteria.dom.right
                ...
                // Update the details in the current tractors criteria array
            ...
            criteria.dom.left
                ...
                //  bubbling is also possible, but that is slow with deep levelled tractors
                _this.s.topGroup.trigger('dtsb-redrawContents');
                _this.s.dt.draw();
                return false;
            });
        ...
        /**
         * Sets listeners for sub tractors of this group
         *
